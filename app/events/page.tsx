...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: "Digital Signage Events | Meister Signage",
    description: "Digitale Beschilderung und Bildschirmlösungen für Events, Messen und Veranstaltungen. Flexibel, professionell und einfach betreut.",
    images: [{ url: `${SITE_URL}/og/meister-signage-og.png`, width: 1200, height: 630, alt: "Digital Signage Events – Meister Signage" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Digital Signage Events | Meister Signage",
    description: "Digitale Beschilderung und Bildschirmlösungen für Events, Messen und Veranstaltungen.",
