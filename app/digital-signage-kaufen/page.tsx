...
export const metadata: Metadata = {
  ...
  description:
    "Digital-Signage-Displays kaufen für Gastronomie, Retail, Unternehmen und Empfangsbereiche. Professionell geplant, schlüsselfertig eingerichtet und persönlich betreut.",
