...
/* Use-Cases aus content/site/homepage-usecases.json — via CMS editierbar. */
import useCasesData from "@/content/site/homepage-usecases.json";
const useCases: UseCase[] = useCasesData.items;
