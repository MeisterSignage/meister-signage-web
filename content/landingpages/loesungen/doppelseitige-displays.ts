...
const page: LandingPage = {
  ...
  cta: {
    ...
    title: "Zwei Seiten. Zwei Botschaften.",
    subtitle:
      "Zeigen Sie auf einer Seite Orientierung und auf der anderen Seite Angebote, Branding oder Eventinformationen – wir empfehlen die passende Lösung.",
